<template>
    <Base>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Locations List</h1>
            <li class="breadcrumb-item" style="list-style: none;">
                <router-link class="btn btn-primary" to="/admin/location/create">+ New</router-link>
            </li>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
const fetchItems = async () => {
    try {
        const response = await axios.get('/api/admin/locations'); // Updated endpoint to '/locations'
        items.value = response.data; // Adjusted based on actual response structure
    } catch (error) {
