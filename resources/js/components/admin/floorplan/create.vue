<template>
    <Base>
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create FloorPlan</h1>
        ...
        <div class="col-lg-12">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Create FloorPlan</h6>
            </div>
  ...
  const submitForm = async () => {
    ...
    try {
      await axios.post('/api/admin/floorplans', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      router.push('/admin/floorplans'); // Redirect after successful creation
    } catch (error) {
