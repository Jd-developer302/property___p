    ...
    <Base>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <li class="breadcrumb-item" style="list-style: none;">
                <router-link class="btn btn-primary" to="/admin/developers">- Back</router-link>
            </li>
        </div>
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="row mb-3 mt-3 mx-3">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" @change="handleFileUpload('logo', $event)" name="logo">
                                    </div>
                                </div>
                            </div>
...
const submitForm = async () => {
    ...
    try {
        await axios.post('/api/admin/developers', formData, {
            headers: {
