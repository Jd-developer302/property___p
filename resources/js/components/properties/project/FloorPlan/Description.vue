        ...
        <div class="container">
            <div class="row"> 
                <div class="col-lg-8  pb-3">
                    <div class="floor-plan card block mb-3">
                        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                            <h2 class="h4 has-line mb-0">Floor Plan</h2>
                            <div class="tab-content">
                                <p>The Art Bay East tower floor plans by Ellington Properties offers studios to spacious 3-bedroom apartments, with an enormous size variation. 8 Studio units introduce an efficient living space starting at 430 square feet, while all 50 1-bedroom units are much larger and range between 862 to 959 square feet. For those seeking even more living room space, there are 32 2-bedroom units that vary from 1211 to 1692 square feet, while all 9 3-bedroom units go to 2147 square feet. Large windows and big balconies allow more natural light and ventilation in space.</p>
                            </div>
                            <nav id="ContentPlaceHolder1_bdrCatId"><div id="nav-tab" role="tablist" class="nav nav-tabs"><a data-toggle="tab" href="#nav-Floor-Plans" role="tab" aria-controls="nav-Floor-Plans" aria-selected="True" class="nav-item nav-link nav-link active">Floor Plans</a></div></nav>
                        </div>
                        <div id="ContentPlaceHolder1_FloorId" class="tab-content"><div id="nav-Floor-Plans" role="tabpanel" aria-labelledby="nav-Floor-Plans-tab" class="tab-pane fade show active"><div class="floor"><div class="card mb-3"><div class="card-header">Various Sizes</div><div class="card-body p-2"><div class="table-responsive"><table class="table mb-0"><tbody><tr><td><a href="https://manage.goldpillars.ae/Project/Floor_Image/1614/Gallery/28149.webp"><img src="https://manage.goldpillars.ae/Project/Floor_Image/1614/Gallery/28149.webp" width="100" height="56" alt="Various Sizes" class="img-fluid"><span class="inlarge"><i class="fa fa-search-plus"></i> View Enlarge</span></a></td><td>-</td></tr></tbody></table></div></div></div></div></div></div>
                    </div>
                    <section class="similar-properties card mt-md-5 block">
                        <h2 class="h4 has-line">Recent Projects by Ellington Group </h2>

                        <div class="row">
                            <div class="col-md-4"><div class="property mb-lg-0"><div class="image"><img src="https://manage.goldpillars.ae/Project/Project_Index/1598/Thumb/1598.webp" width="800" height="450" alt="Ellington Belgrove Residences" class="img-fluid cover"><div class="overlay d-flex align-items-center justify-content-center"><a href="/project/ellington-belgrove-residences" class="btn btn-light btn-sm">View Details</a> </div></div><div class="info"><a href="/project/ellington-belgrove-residences" class="no-anchor-style"><h3 class="text-thin mb-1">Ellington Belgrove Residences</h3></a><p class="loc">Al Merkadh</p></div></div></div><div class="col-md-4"><div class="property mb-lg-0"><div class="image"><img src="https://manage.goldpillars.ae/Project/Project_Index/1550/Thumb/1550.webp" width="800" height="450" alt="Ellington The Watercrest" class="img-fluid cover"><div class="overlay d-flex align-items-center justify-content-center"><a href="/project/ellington-the-watercrest" class="btn btn-light btn-sm">View Details</a> </div></div><div class="info"><a href="/project/ellington-the-watercrest" class="no-anchor-style"><h3 class="text-thin mb-1">Ellington The Watercrest</h3></a><p class="loc">Al Merkadh</p></div></div></div><div class="col-md-4"><div class="property mb-lg-0"><div class="image"><img src="https://manage.goldpillars.ae/Project/Project_Index/1506/Thumb/1506.webp" width="800" height="450" alt="Rosemont Residences" class="img-fluid cover"><div class="overlay d-flex align-items-center justify-content-center"><a href="/project/rosemont-residences" class="btn btn-light btn-sm">View Details</a> </div></div><div class="info"><a href="/project/rosemont-residences" class="no-anchor-style"><h3 class="text-thin mb-1">Rosemont Residences</h3></a><p class="loc">Al Barsha South Fifth</p></div></div></div>
                        </div>
...
<div class="card new_form border-0 bg-white d-none d-md-block mb-4">
    ...
    <div class="card-body">
        <div class="form-group">
            <input type="text" id="txtName" class="form-control" placeholder="Name *" onblur="fnnameqcHome();" oninput="fnchkbtnqcHome();">
            <small class="text-danger d-none" id="spName"></small>
        </div>
        <div class="form-group">
            <input type="text" id="txtEmail" class="form-control" placeholder="Email Id *" onblur="fnemailqcHome();" oninput="fnchkbtnqcHome();">
            <small class="text-danger d-none" id="spEmail"></small>
        </div>
        <div class="form-group"> 
           <select name="ctl00$ContentPlaceHolder1$enquiryform$ddlQueryType" id="ddlQueryType" class="form-control" onchange="fnquerytypeqcHome();">
	...
	<option value="4">Others</option>
            ...
            <div class="col-12">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="txtContactNo" class="form-control" placeholder="Contact No *" >
                    </div>
        ...
        <div class="form-group">
            <button id="btntempsubmit" type="button" class="btn btn-primary btn-block d-block" >Send Message</button>
...
<div class="card download-new border-0 mb-4">
    <div class="card-body">
        <a href="#"  title="Buy With Bitcoin" data-toggle="modal" data-target="#paybitcoin">
            <img src="" width="385" height="83" alt="Buy With Bitcoin" class="img-fluid"></a>
    </div>
</div>
...
<div class="card download-new border-0">
    ...
    <div class="card-header">Download
        <img src="" width="18" height="18" alt="Download"></div>
...
dialog, figure, footer, header, main, nav, section {
    display: block
}
...
.form-control-sm, .input-group-sm > .form-control, .input-group-sm > .input-group-prepend > .btn, .input-group-sm > .input-group-prepend > .input-group-text {
    padding: .25rem .5rem;
    font-size: .875rem;
    line-height: 1.5;
    border-radius: .2rem
...
.input-group-sm > .input-group-prepend > select.btn:not([size]):not([multiple]), .input-group-sm > .input-group-prepend > select.input-group-text:not([size]):not([multiple]), .input-group-sm > select.form-control:not([size]):not([multiple]), select.form-control-sm:not([size]):not([multiple]) {
    height: calc(1.8125rem+2px)
}

.form-control-lg, .input-group-lg > .form-control, .input-group-lg > .input-group-prepend > .btn, .input-group-lg > .input-group-prepend > .input-group-text {
    padding: .5rem 1rem;
    font-size: 1.25rem;
    line-height: 1.5;
    border-radius: .3rem
...
.input-group-lg > .input-group-prepend > select.btn:not([size]):not([multiple]), .input-group-lg > .input-group-prepend > select.input-group-text:not([size]):not([multiple]), .input-group-lg > select.form-control:not([size]):not([multiple]), select.form-control-lg:not([size]):not([multiple]) {
...
@media(min-width: 576px) {
    ...
    .card-group > .card:not(:first-child):not(:last-child):not(:only-child) .card-footer, .card-group > .card:not(:first-child):not(:last-child):not(:only-child) .card-header, .card-group > .card:not(:first-child):not(:last-child):not(:only-child) .card-img-top {
        border-radius: 0
    }
}
...
.bootstrap-select.form-control:not([class*=col-]), .form-inline .bootstrap-select.btn-group .form-control {
    width: 100%
}
...
.form-group .bootstrap-select.btn-group, .form-inline .bootstrap-select.btn-group {
    margin-bottom: 0
}
...
@charset "UTF-8";@font-face {
    ...
    src: url(/fonts/real-estated41d.eot?#iefix) format("embedded-opentype"),url(/fonts/real-estate.woff) format("woff"),url(/fonts/real-estate.ttf) format("truetype"),url(/fonts/real-estate.svg#real-estate) format("svg");
    font-display: swap;
    font-weight: 400;
    font-style: normal
}
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Squada One'),local('SquadaOne-Regular'),url(/fonts/BCasqZ8XsOrx4mcOk6Mtaac2WQ.woff2) format('woff2');
    unicode-range: U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
.bg-black-2 .form-control {
    background: #2c2c2c;
    border: dashed 1px #7b5e0b !important
}
...
#font-setting-buttons .btn:last-child {
    font-size: 16px
}
...
.property-single-features ol, .property-single-features ul {
    color: #444;
    font-size: 16px;
    font-weight: 400
}
...
.top-bar .menu-right a:focus, .top-bar .menu-right a:hover {
    color: #f3c84b
}
...
.top-bar .menu-right .laung {
    text-align: center
}

.top-bar .menu-right .laung img {
    width: 15px
}

.top-bar .menu-right .laung span {
    display: block;
    font-size: 10px;
    color: #fff;
...
nav.navbar .es .nav-link, nav.navbar .ru .nav-link {
    letter-spacing: 0;
    margin-right: 0
}
...
nav.navbar a.laung img {
    width: 18px
}

nav.navbar a.laung span {
    display: inline-block;
    font-size: 9px;
    color: #000;
    letter-spacing: .5px
...
.main-slider .inner-banner:before {
    content: '';
...
.main-slider .inner-banner .img-bnr {
    width: 100%;
    height: 100%;
    overflow: hidden;
    object-fit: cover
...
.main-slider.offer-bnr {
    min-height: calc(70vh - 75px);
    background: -webkit-gradient(linear,right top,left top,from(#666),to(#000));
    background: linear-gradient(270deg,#666,#000);
    padding-top: 22vh
}

.main-slider.offer-bnr h2 {
    background: -webkit-linear-gradient(hsla(0,0,100%,.37),rgba(50,50,50,0));
...
.offer-img {
    background: url(/images/sp-offers.png) no-repeat;
    position: absolute;
    right: -9px;
    width: 178px;
    height: 195px;
...
#Priceinfo .modal-content button:focus {
    outline: 0
}

#Priceinfo .modal-content table {
    margin-bottom: 0
}
...
.pro-summary .price h3 {
    color: #f3c84b;
    font-size: 18px;
    margin: 0
}

.pro-summary .price h3 i {
    cursor: pointer
}
...
.new-properties .container-fluid {
...
.similar-properties .arrow-left {
    ...
    outline: 0;
    background: url(/images/left-arrow.png) no-repeat 10px rgba(255,255,255,.71);
    right: 40px;
    padding: 0 3px 0 0;
    background-size: 15px
}

.similar-properties .arrow-right {
    position: absolute;
    height: 32px;
    z-index: 2;
    width: 32px;
    ...
    box-shadow: 0 1px 5px rgba(0,0,0,.7);
    outline: 0;
    background: url(/images/right-arrow.png) no-repeat 10px rgba(255,255,255,.71);
    right: 0;
    padding: 0 3px 0 0;
    background-size: 15px
}
...
.toggle-features:focus, .toggle-features:hover {
    color: #f3c84b;
    text-decoration: none
}
...
.floor-plan a, .payment-plan a, .property-single-description a, .property-single-features a, .property-single-map a {
    color: #585858
}

.floor-plan p a, .payment-plan p a, .property-single-features p a, .property-single-map p a {
    font-weight: 600
}

.floor-plan p a:hover, .payment-plan p a:hover, .property-single-features p a:hover, .property-single-map p a:hover {
    text-decoration: none;
    color: inherit
}
...
.floor-plan .nav-tabs, .property-single-map .nav-tabs {
    border-bottom: 0
}

.floor-plan a.nav-link, .property-single-map a.nav-link {
    border: 0;
    border-radius: 50px;
    font-size: .85rem;
    padding: 5px 20px;
...
.floor-plan a.nav-link.active, .property-single-map a.nav-link.active {
    background: #f3c84b;
    color: #fff
}
...
.floor-plan .table td, .floor-plan .table th {
    padding: 5px;
    vertical-align: top;
    border-top: 0;
    color: #636262;
...
.payment-plan table td, .payment-plan table th {
    padding: 10px;
    font-size: 13px;
    border: 0;
    color: #343a40
...
.g-type.nav-tabs .nav-link.active {
    color: #fff;
...
.property-single-map .arrow-left {
    position: absolute;
    height: 42px;
    z-index: 2;
    width: 42px;
    ...
    outline: 0;
    background: url(/images/left-arrow.png) no-repeat 10px #fff;
    left: -21px;
    padding: 0 4px 0 0
}

.property-single-map .arrow-right {
    position: absolute;
    height: 42px;
    z-index: 2;
    width: 42px;
    ...
    box-shadow: 0 1px 3px rgba(0,0,0,.3);
    outline: 0;
    background: url(/images/right-arrow.png) no-repeat 10px #fff;
    right: -21px;
    padding: 0 4px 0 0
}
...
.property-gallery .gallery figure img {
    -webkit-transition: all .9s;
    transition: all .9s
}

.property-gallery .gallery figure:hover img {
    transform: scale(1.3);
    cursor: zoom-in
}
...
.download-new ul li:first-child {
    border-top: 0
}
...
.amenities .has-line::after, .property-gallery .has-line::after {
    margin: 10px auto
}
...
.bitcoin-modal .form-control {
    padding: 8px 15px
}

.bitcoin-modal textarea {
    padding: 8px 15px;
    min-height: 55px;
    font-size: 11px;
    color: #868e96
...
.bitcoin-modal .input-group-prepend select.form-control {
...
.btn:focus {
    outline: 0;
    -webkit-box-shadow: 0 0 0 .2rem rgba(89,137,229,.25);
    box-shadow: 0 0 0 .2rem rgba(89,137,229,.25)
}
...
.btn-primary:focus {
    -webkit-box-shadow: 0 0 0 .2rem rgba(89,137,229,.5);
    box-shadow: 0 0 0 .2rem rgba(89,137,229,.5)
}
...
.bg-primary {
    background-color: #f3c84b !important
}
...
.floating-label-wrap select.form-control:not([size]):not([multiple]) {
...
@media(max-width: 767px) {
    ...
    footer.footer .copyrights .text-right {
        text-align: center !important
    }
    ...
    .property-gallery .gallery .row [class*=col-]:nth-child(n+4) {
        display: none
    }
...
.lg-outer .lg-pager-thumb-cont {
    ...
    width: 120px;
    border-radius: 3px;
    -webkit-transition: opacity .15s,-webkit-transform .15s 0;
    -moz-transition: opacity .15s,-moz-transform .15s 0;
    -o-transition: opacity .15s,-o-transform .15s 0;
    transition: opacity .15s,transform .15s 0;
    -webkit-transform: translate3d(0,5px,0);
    transform: translate3d(0,5px,0)
}
...
.lg-outer .lg-dropdown {
    ...
    -webkit-transform: translate3d(0,5px,0);
    transform: translate3d(0,5px,0);
    -webkit-transition: -webkit-transform .18s linear,visibility 0 linear .5s,opacity .18s linear 0;
    -moz-transition: -moz-transform .18s linear,visibility 0 linear .5s,opacity .18s linear 0;
    -o-transition: -o-transform .18s linear,visibility 0 linear .5s,opacity .18s linear 0;
    transition: transform .18s linear,visibility 0 linear .5s,opacity .18s linear 0
}
...
.lg-css3.lg-slide.lg-use-css3 .lg-item.lg-current, .lg-css3.lg-slide.lg-use-css3 .lg-item.lg-next-slide, .lg-css3.lg-slide.lg-use-css3 .lg-item.lg-prev-slide {
    -webkit-transition: -webkit-transform 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
    -moz-transition: -moz-transform 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
    -o-transition: -o-transform 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
...
.lg-css3.lg-slide.lg-use-left .lg-item.lg-current, .lg-css3.lg-slide.lg-use-left .lg-item.lg-next-slide, .lg-css3.lg-slide.lg-use-left .lg-item.lg-prev-slide {
    -webkit-transition: left 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
    -moz-transition: left 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
    -o-transition: left 1s cubic-bezier(0,0,.25,1),opacity .1s 0;
