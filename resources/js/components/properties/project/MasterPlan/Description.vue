        ...
        <div class="container">
            <div class="row"> 
                <div class="col-lg-8 pb-3">
                    <div class="property-single-map card block mb-3">
                        <h2 class="h4 has-line">Master Plan</h2>
                        <p>Ellington Art Bay East Master Plan at Al Jaddaf, Dubai</p>
                        <div class="loc">
                            <a href="https://manage.goldpillars.ae/Project/LayoutPlan/1614/Thumb/1620.webp">
                                <img src="https://manage.goldpillars.ae/Project/LayoutPlan/1614/Thumb/1620.webp" width="1000" height="700" alt="Master Plan" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <section class="similar-properties card mt-md-5 block">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4">
                                <a href="https://www.goldpillars.ae/developer/ellington-group" class="btn btn-dark btn-block border mt-md-3 float-md-right">More Projects</a>
                            </div>
                        </div>
                    </section>
                </div>
