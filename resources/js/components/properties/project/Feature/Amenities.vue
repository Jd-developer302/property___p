                ...
                <div v-else>
                  ...
                  <section class="similar-properties card mt-md-5 block">
                    <h2 class="h4 has-line">
                      Recent Projects by {{ feature.project?.name || 'Loading...' }}
                    </h2>
      
                    <div class="row">
                      <!-- Check if feature.project is defined -->
                      <div v-if="feature.project" class="col-md-4">
                        <div class="property mb-lg-0">
                          <div class="image">
                            <!-- Use feature.project.image safely -->
                            <img
                              :src="feature.project.image ? `/storage/${feature.project.image}` : '/images/default-image.png'"
                              width="800"
                              height="450"
                              :alt="feature.project.name"
                              class="img-fluid cover"
                            />
                            <div class="overlay d-flex align-items-center justify-content-center">
                              <a :href="`/projects/${feature.project.id}`" class="btn btn-light btn-sm">View Details</a>
                            </div>
                          </div>
                          <div class="info">
                            <a :href="`/projects/${feature.project.id}`" class="no-anchor-style">
                              <h3 class="text-thin mb-1">{{ feature.project.name }}</h3>
                            </a>
                          </div>
                        </div>
                      </div>
                      <!-- Display a message if no project is available -->
                      <div v-if="!feature.project" class="col-md-12">
