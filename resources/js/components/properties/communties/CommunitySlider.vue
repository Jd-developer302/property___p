<template>
    <section id="projects" class="bg-light py-3 py-lg-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-8 text-center">
            <h3 class="mb-0">
              Housing Projects
              <span class="d-block">in JVC</span>
            </h3>
          </div>
        </div>
        ...
        <vue-slick-carousel
          ...
          class="proj owl-theme"
        >
          <div v-for="(project, index) in projects" :key="index" class="item">
            <div class="row pro-thum mt-4 my-lg-4 py-2 py-lg-3 justify-content-end align-items-center">
              <div class="col-lg-6 order-lg-2 pro-images">
                <div class="pro-logo">
                  <img
                    width="172"
                    height="80"
              ...
              <div class="col-lg-5 order-lg-1 details">
                <div class="card left">
                  <div class="card-body">
                    <h2>
                    ...
                    <a
                      ...
                      data-toggle="modal"
                      data-target="#myModal"
                      class="btn btn-danger mr-2 dw_pdf"
                      >Brochure Download</a
                    >
                    <a
                      :href="project.paymentPlanUrl"
                      class="btn btn-outline-danger mr-2 dw_pdf"
                      >Payment Plan</a
                    >
                    <a :href="project.url" class="btn btn-outline-danger mr-2"
                      >Explore More</a
                    >
                  </div>
                </div>
    ...
    data() {
      return {
        ...
        projects: [
          {
            name: 'Elitz 3',
            logo: 'https://manage.goldpillars.ae/Project/Project_Logo/1294/Thumb/1294.webp',
            image: 'https://manage.goldpillars.ae/Project/Project_Index/1294/Thumb/1294.webp',
            url: 'https://www.goldpillars.ae/project/elitz-3',
            description: 'Elitz 3 by Danube Properties is an extraordinary residential tower development that features luxury apartments located at Jumeirah Village Circle - JVC, Dubai.',
            bedrooms: 'Studio, 1, 2, & 3 Bedroom',
            completionDate: 'Q4 - 2026',
            price: 'AED 700,000',
            paymentPlan: '10%',
            paymentPlanUrl: 'https://www.goldpillars.ae/project/elitz-3-payment-plan',
          },
          // Add more projects...
        ],
      };
