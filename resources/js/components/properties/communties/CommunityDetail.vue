                ...
                <div class="col-lg-8 col-md-9 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            <div class="card">
                                <a href="JavaScript:Void(0);" class="list-cat">101 Projects</a>
                                <a class="listing-item" href="#" target="_blank">
                                    <div class="listing-items">
                                        <div class="listing-shot-img">
                                            <img width="800" height="450"
                                                src="https://manage.goldpillars.ae/Township/Township_Image/16/Thumb/16.webp"
                                                class="img-responsive" alt="strCommunityName">
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <div class="listing-shot-caption">
                                        <h4>JVC</h4>
                                        <p class="my-1">Jumeirah Village Circle or JVC, as it is popularly known, is a
                                            community that has been conceived to provide its residents with a
                                            cosmopolitan lifestyle.</p>
                                        <a class="btn-hover default-btn mt-3" href="#" target="_blank">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            <div class="card">
                                <a href="JavaScript:Void(0);" class="list-cat">62 Projects</a>
                                <a class="listing-item" href="#" target="_blank">
                                    <div class="listing-items">
                                        <div class="listing-shot-img">
                                            <img width="800" height="450"
                                                src="https://manage.goldpillars.ae/Township/Township_Image/6/Thumb/6.webp"
                                                class="img-responsive" alt="strCommunityName">
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <div class="listing-shot-caption">
                                        <h4>Business Bay</h4>
                                        <p class="my-1">Featuring tall skyscrapers along with investment-friendly
                                            developments, Business Bay in Dubai is an exclusive community offers
                                            commercial & residential properties.</p>
                                        <a class="btn-hover default-btn mt-3" href="#" target="_blank">Read More</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            <div class="card">
                                <a href="JavaScript:Void(0);" class="list-cat">44 Projects</a>
                                <a class="listing-item" href="#" target="_blank">
                                    <div class="listing-items">
                                        <div class="listing-shot-img">
                                            <img width="800" height="450"
                                                src="https://manage.goldpillars.ae/Township/Township_Image/14/Thumb/14.webp"
                                                class="img-responsive" alt="strCommunityName">
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <div class="listing-shot-caption">
                                        <h4>Dubailand</h4>
                                        <p class="my-1">Dubailand is a premium tourist and lifestyle destination by
                                            Dubai Properties. Spanning over 3 million sq.ft, the district is divided
                                            into several residential communities.</p>
                                        <a class="btn-hover default-btn mt-3" href="#" target="_blank">Read More</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            <div class="card">
                                <a href="JavaScript:Void(0);" class="list-cat">43 Projects</a>
                                <a class="listing-item" href="#" target="_blank">
                                    <div class="listing-items">
                                        <div class="listing-shot-img">
                                            <img width="800" height="450"
                                                src="https://manage.goldpillars.ae/Township/Township_Image/7/Thumb/7.webp"
                                                class="img-responsive" alt="strCommunityName">
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <div class="listing-shot-caption">
                                        ...
                                        <p class="my-1">Downtown Dubai by Emaar properties is an iconic and
                                            exceptionally designed mega- community, located right in the heart of Dubai.
                                        </p>
                                        <a class="btn-hover default-btn mt-3" href="#" target="_blank">Read More</a>
                                    </div>
                                </div>
