<template>
    ...
    <div class="breadcrumb__area">
        ...
        <div class="breadcrumb__content">
            <h2 class="breadcrumb__title">Property Investment offers</h2>
                ...
                <nav>
                    <ul>
                        ...
                        <li class="breadcrumb-list "><span><i class="fa-solid fa-angle-double-right"></i><a
                                    href="/projects">Property Investment offers</a></span></li>
                    </ul>
                </nav>
            </div>
...
<script setup>
    ...
    import InvestmentDetail from '../investment/InvestmentDetail.vue'
