            ...
            <div class="row">
                <div class="col-lg-8 col-md-9 col-sm-12">
                    ...
                    <div class="sec-heading mx-auto">
                        ...
                        <p>Know More about the popular and investment-friendly residential properties in and around
                            Dubai. The projects by leading real estate developers are primed to offer modern and
                            contemporary homes for those with refined taste and preference.</p>
                    </div>
                    <div class="row">
                                ...
                                <a href="#">
                                    <div class="event-grid-header offes">
                                        <img width="358" height="287"
                                            src="https://www.goldpillars.ae/images/City/Abu-Dhabi.jpg"
                                            class="img-fluid mx-auto" alt="Abu Dhabi">
                                        <span class="event-grid-cat">Abu Dhabi</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="event-grid-wrap">
                                <a href="#">
                                    <div class="event-grid-header offes">
                                        <img width="358" height="287"
                                            src="https://www.goldpillars.ae/images/City/Ajman.jpg"
                                            class="img-fluid mx-auto" alt="Ajman">
                                        <span class="event-grid-cat">Ajman</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="event-grid-wrap">
                                <a href="#">
                                    <div class="event-grid-header offes">
                                        <img width="358" height="287"
                                            src="https://www.goldpillars.ae/images/City/Dubai.jpg"
                                            class="img-fluid mx-auto" alt="Dubai">
                                        <span class="event-grid-cat">Dubai</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="event-grid-wrap">
                                <a href="#">
                                    <div class="event-grid-header offes">
                                        <img width="358" height="287"
                                            src="https://www.goldpillars.ae/images/City/Egypt.jpg"
                                            class="img-fluid mx-auto" alt="Egypt">
                                        <span class="event-grid-cat">Egypt</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="widget-boxed-body">
                            <div class="side-list">
                                <ul id="ContentPlaceHolder1_TopCommunityId" class="category-list">
                                    <li><a href="/properties-for-sale-at-jvc">JVC<span>101
                                                <small>Projects</small></span></a></li>
                                    <li><a href="/properties-for-sale-at-business-bay">Business Bay<span>62
                                                <small>Projects</small></span></a></li>
                                    <li><a href="/properties-for-sale-at-dubailand">Dubailand<span>44
                                                <small>Projects</small></span></a></li>
                                    <li><a href="/properties-for-sale-at-downtown-dubai">Downtown Dubai<span>43
                                                <small>Projects</small></span></a></li>
                                    <li><a href="/properties-for-sale-at-dubai-hills-estate">Dubai Hills Estate<span>38
                                                <small>Projects</small></span></a></li>
                                </ul>
                            </div>
                        </div>
