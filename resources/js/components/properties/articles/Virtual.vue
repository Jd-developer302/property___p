    ...
    <div class="widget-boxed-header">
                        ...
                        <div class="widget-boxed-body">
                            <div id="walkthroughId" class="row walkthrough">
                                <div class="col-md-6" v-for="project in limitedProjects" :key="project.id">
                                    <div class="walk-warp"><a :href="`/projects/${project.slug}`"><span><img width="64" height="37"
                                                ...
                                                alt="Villanova La Rosa" class="img-fluid"></a></div><a :href="`/projects/${project.slug}`">
                                        <h3>{{ project.name }}</h3>
                                    </a>
                                </div>
                            ...
                            <a href="/projects" class="btn btn-primary btn-block">View
                                All</a>
                        </div>
</template>
<script>
