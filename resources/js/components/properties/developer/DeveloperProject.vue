<template>
    <div class="page-title image-title" :style="{ 
        backgroundImage: `url(${projects.length > 0 ? `/storage/${projects[0].image}` : '/images/default-image.png'})`
      }">
      <div class="finding-overlay op-70"></div>
      <div class="container">
        <div class="page-title-wrap">
          <h1 class="bnr-title">{{ developer.name }}</h1>
          <ul class="banner-cat-list">
            <li><a href="JavaScript:Void(0);">{{ projects.length }} +<span> Projects</span></a></li>
            <li><a href="JavaScript:Void(0);">{{ communities.length }} +<span> Communities</span></a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        axios
          ...
          .then((response) => {
            ...
            if (this.projects.length > 0) {
              this.developer = this.projects[0].developer;
            }
          })
          .catch((error) => {
...
.topbar.fixed-header .act-buttons a.login,a {
    color: #546e7a
}

.menuBox,.menuBox .overlay {
    right: 0;
    height: 100%;
    width: 100%
}

.topbar.fixed-header,body,html {
    background: #fff
}

.dropzone .dz-preview .dz-details .dz-filename:not(:hover),.pricing h3 {
    overflow: hidden;
...
.menuBox .content li a,.navbar-brand:focus,.navbar-brand:hover,a,a:focus,a:hover {
...
.col,.col-lg-3,.col-lg-4,.col-lg-8,.col-lg-9,.col-md-12,.col-md-3,.col-md-4,.col-md-8,.col-md-9,.col-sm-12,.col-sm-6 {
    position: relative;
    width: 100%;
    min-height: 1px;
    padding-right: 15px;
...
@font-face {
    ...
    src: url(src/datedropperd41d.eot?#iefix) format("embedded-opentype"),url(src/datedropper.woff) format("woff"),url(src/datedropper.ttf) format("truetype"),url(src/datedropper.svg#datedropper) format("svg");
    font-weight: 400;
    font-style: normal
}
...
@font-face {
    ...
    src: url(/fonts/fontello6c7f.eot?59946131);
    src: url(/fonts/fontello6c7f.eot?59946131#iefix) format("embedded-opentype"),url(/fonts/fontello6c7f.woff2?59946131) format("woff2"),url(/fonts/fontello6c7f.woff?59946131) format("woff"),url(/fonts/fontello6c7f.ttf?59946131) format("truetype"),url(/fonts/fontello6c7f.svg?59946131#fontello) format("svg");
    font-weight: 400;
    font-style: normal;
    font-display: swap
}
...
.menuBox .clse span,.menuBox .clse span:before,.menuBox .content {
...
.menuBox .content li a:hover,ul.footer-bottom-social li a:focus,ul.footer-bottom-social li a:hover {
    color: #ff7600
}
...
.small.list-grid-layout a.list-thumb img {
    object-fit: cover;
    height: 100%;
    max-height: 250px
}

.small.modern-layout .grid-layout-body {
    padding: 15px;
    margin-top: 0
}

.small.modern-layout .gl-list-caption {
    padding: 0;
    display: block;
    vertical-align: bottom
}

.small.modern-layout .grid-layout-info {
    width: 100%;
    height: auto;
    padding: 0;
    font-size: 13px
...
.title h2 {
    font-size: 22px;
    display: inline-block;
    border-top: 1px solid #b28d2b;
    border-bottom: 1px solid #b28d2b;
    padding: 3px 10px
}

.statics {
    padding: 5rem 0;
    background: url(../images/statics-bg.jpg) 0 0/cover no-repeat
}

.statics .num_count p,.statics p {
    font-size: 16px;
    color: #fff;
    letter-spacing: 1px;
    margin-top: 22px;
...
.fixed-header .header.exchange-logo .sticky-logo,.header.exchange-logo .default-logo,.header.exchange-logo .sticky-logo {
    display: none
}
...
@media(max-width: 991px) {
    .act-buttons a.laung span,.header.exchange-logo .sticky-logo {
        display:none
    }
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Crimson Text Italic'),local('CrimsonText-Italic'),url(../fonts/wlpogwHKFkZgtmSR3NB0oRJfajhRK_Y.woff2) format('woff2');
    unicode-range: U+0-FF,U+131,U+152-153,U+2BB-2BC,U+2C6,U+2DA,U+2DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
@font-face {
    ...
    font-weight: 600;
    font-display: swap;
    src: local('Crimson Text SemiBold Italic'),local('CrimsonText-SemiBoldItalic'),url(../fonts/wlprgwHKFkZgtmSR3NB0oRJfajCOD-NS_LU.woff2) format('woff2');
    unicode-range: U+0-FF,U+131,U+152-153,U+2BB-2BC,U+2C6,U+2DA,U+2DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
@font-face {
    ...
    font-weight: 600;
    font-display: swap;
    src: local('Crimson Text SemiBold'),local('CrimsonText-SemiBold'),url(../fonts/wlppgwHKFkZgtmSR3NB0oRJXsCxGDNNQ.woff2) format('woff2');
    unicode-range: U+0-FF,U+131,U+152-153,U+2BB-2BC,U+2C6,U+2DA,U+2DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Charm Regular'),local('Charm-Regular'),url(../fonts/7cHmv4oii5K0MdY8K-4E4Q.woff2) format('woff2');
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Charm Regular'),local('Charm-Regular'),url(../fonts/7cHmv4oii5K0MdYnK-4E4Q.woff2) format('woff2');
    unicode-range: U+102-103,U+110-111,U+128-129,U+168-169,U+1A0-1A1,U+1AF-1B0,U+1EA0-1EF9,U+20AB
}
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Charm Regular'),local('Charm-Regular'),url(../fonts/7cHmv4oii5K0MdYmK-4E4Q.woff2) format('woff2');
    unicode-range: U+100-24F,U+259,U+1E00-1EFF,U+2020,U+20A0-20AB,U+20AD-20CF,U+2113,U+2C60-2C7F,U+A720-A7FF
}
...
@font-face {
    ...
    font-weight: 400;
    font-display: swap;
    src: local('Charm Regular'),local('Charm-Regular'),url(../fonts/7cHmv4oii5K0MdYoK-4.woff2) format('woff2');
    unicode-range: U+0-FF,U+131,U+152-153,U+2BB-2BC,U+2C6,U+2DA,U+2DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
@font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Charm Bold'),local('Charm-Bold'),url(../fonts/7cHrv4oii5K0Md6TDvsvwH8RnA.woff2) format('woff2');
    unicode-range: U+E01-E5B,U+200C-200D,U+25CC
}
...
@font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Charm Bold'),local('Charm-Bold'),url(../fonts/7cHrv4oii5K0Md6TDvs0wH8RnA.woff2) format('woff2');
    unicode-range: U+102-103,U+110-111,U+128-129,U+168-169,U+1A0-1A1,U+1AF-1B0,U+1EA0-1EF9,U+20AB
}
...
@font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Charm Bold'),local('Charm-Bold'),url(../fonts/7cHrv4oii5K0Md6TDvs1wH8RnA.woff2) format('woff2');
    unicode-range: U+100-24F,U+259,U+1E00-1EFF,U+2020,U+20A0-20AB,U+20AD-20CF,U+2113,U+2C60-2C7F,U+A720-A7FF
}
...
@font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Charm Bold'),local('Charm-Bold'),url(../fonts/7cHrv4oii5K0Md6TDvs7wH8.woff2) format('woff2');
    unicode-range: U+0-FF,U+131,U+152-153,U+2BB-2BC,U+2C6,U+2DA,U+2DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD
}
...
.footer-widget,.header-nav-bar,html body .p-0 {
    padding: 0
}
...
.list-grid-layout a.list-thumb,.tp-author-box .author-cover-img {
...
.act-buttons a.login,.footer-widget ul li a,.page-title-wrap a,footer .contact a {
    color: #fff
}
...
ul.banner-cat-list li a:focus,ul.banner-cat-list li a:hover {
    background: #fff;
...
ul.banner-cat-list li a:focus span,ul.banner-cat-list li a:hover span {
    color: #575d67
}
...
.ft-loke a:focus,.ft-loke a:hover {
    -webkit-transition: .5s;
    transition: .5s;
    color: #ff7600
}

.list-grid-layout.modern-layout {
    background: #fff;
    position: relative;
    width: 100%;
...
.modern-layout .grid-layout-info {
    width: 100%;
    height: auto;
...
.list-grid-layout:focus a.list-thumb,.list-grid-layout:hover a.list-thumb {
...
.list-grid-layout.modern-layout:hover a.list-thumb:before {
    opacity: .6
}

.grid-layout-info ul,ul.footer-bottom-social {
    margin: 0;
    padding: 0
}
...
.grid-layout-info li i,footer .contact p i,ul.footer-bottom-social li i {
    margin-right: 5px
}
...
.modern-layout .gl-list-caption h4 a {
    color: #32343c
}
...
.card,.card.pricing,.page-title,footer.light-footer {
    position: relative
}

.author-cover-img .price p {
    margin: 0;
    font-size: 11px;
    color: #fff;
    letter-spacing: 1px;
...
.author-cover-img .price .follow-btn {
    color: #c59414;
    font-weight: 600;
    background: #fff;
    padding: 3px 5px;
...
.footer-widget ul li,ul.footer-bottom-social li {
    display: inline-block;
    list-style: none
}
...
.footer-widget ul li,h4.widget-title {
    margin-bottom: 10px;
    text-transform: uppercase
}
