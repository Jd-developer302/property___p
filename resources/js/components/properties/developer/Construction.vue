        ...
        <div class="container">
            <div id="ProjStatusId" class="row">
                <div class="col-md-4 text-center wow fadeIn animated" data-wow-duration="2s">
                    <div class="num_count">
                        <h4><span class="counter">{{ projectStatus.newLaunch }}</span>+</h4>
                        <p>New Launch</p>
                    </div>
                </div>
                <div class="col-md-4 text-center wow fadeIn animated" data-wow-duration="2s">
                    <div class="num_count">
                        <h4><span class="counter">{{ projectStatus.underConstruction }}</span>+</h4>
                        <p>Under Construction</p>
                    </div>
                </div>
                <div class="col-md-4 text-center wow fadeIn animated" data-wow-duration="2s">
                    <div class="num_count">
                        <h4><span class="counter">{{ projectStatus.readyToMove }}</span>+</h4>
                        <p>Ready to Move</p>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        async fetchProjectStatus() {
            try {
                // Fetch the developer slug from route params (if using Vue Router)
                const slug = this.$route.params.slug; // Ensure slug is correct and passed from your router
                
                // Make an API call to fetch the developer's project status
                const response = await axios.get(`/api/developers/${slug}/project-status`);
                
                // Update the project status based on the API response
                this.projectStatus.newLaunch = response.data.new_launch;
                this.projectStatus.underConstruction = response.data.under_construction;
                this.projectStatus.readyToMove = response.data.ready_to_move;
            } catch (error) {
