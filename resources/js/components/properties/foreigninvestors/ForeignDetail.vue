    ...
    <section class="container who-we-are" id="who">
        ...
        <div class="row justify-content-center">
            <div class="col-md-9 text-center">
                <p style="color: #333;">By investing in the lucrative Dubai real estate market, you have a good opportunity to build wealth
                ...
                <div class="col-lg-8 col-md-9 col-sm-12">
                    <div class="proj-list-item mb-4">
                        <div class="row no-gutters">
                            <div class="col-md-5">
                                <a href="#">
                                    <img width="313" height="239" src="https://www.goldpillars.ae/images/bnn2.webp"
                                        alt="Real Estate registration and transfer fees" class="img-fluid">
                                </a>
                            </div>
                            <div class="col-md-7">
                                <div class="card rounded-0 proj-dtls border-0 shadow-sm">
                                    <div class="card-body">
                                        <h2>
                                            <a href="#">Real Estate
                                                registration and transfer fees</a>
                                        </h2>
                                        <p>The process of real- estate registration in the UAE comprises many technical
                                            steps and documentation. It is somewhat chaotic and a tad slow. But given
                                            the circumstances, this is something that is mandatory for you to complete.
                                        </p>
                                        <a class="btn-hover default-btn float-left"
                                            href="#">Read more</a>
                                    </div>
                    ...
                    <div class="proj-list-item mb-4">
                        <div class="row no-gutters">
                            <div class="col-md-5">
                                <a href="#">
                                    <img width="313" height="239" src="https://www.goldpillars.ae/images/bnn3.webp"
                                        alt="Tax system for properties in the UAE" class="img-fluid">
                                </a>
                            </div>
                            <div class="col-md-7">
                                <div class="card rounded-0 proj-dtls border-0 shadow-sm">
                                    <div class="card-body">
                                        <h2>
                                            <a href="#">Tax system for properties in
                                                the UAE</a>
                                        </h2>

                                        <p>In a report published by one of the UK’s leading property firm Knight Frank
                                            that compares property taxes in 15 countries, the results were surprising.
                                            The report showed that people buying properties in Dubai have to pay the
                                            lowest amount of taxes</p>
                                        <a class="btn-hover default-btn float-left"
                                            href="#">Read more</a>
                                    </div>
                    ...
                    <div class="proj-list-item mb-4">
                        <div class="row no-gutters">
                            <div class="col-md-5">
                                <a href="#">
                                    <img width="313" height="239" src="https://www.goldpillars.ae/images/bnn4.webp"
                                        alt="Visa Process for property owners" class="img-fluid">
                                </a>
                            </div>
                            <div class="col-md-7">
                                <div class="card rounded-0 proj-dtls border-0 shadow-sm">
                                    <div class="card-body">
                                        <h2>
                                            <a href="#">Visa Process for property
                                                owners</a>
                                        </h2>

                                        <p>When it comes to the Dubai-based property market, there are multiple options
                                            for you to choose from. Starting with sleek and modern apartments, elegant
                                            townhouses and grand villas as well as various commercial buildings...</p>
                                        <a class="btn-hover default-btn float-left"
                                            href="#">Read more</a>
                                    </div>
                    ...
                    <div class="widget-boxed d-none d-xl-block">
                        ...
                        <div class="widget-boxed-body">
                            <div class="side-list menu-a">
                                <a href="#"
                                    class="btn btn-primary btn-sm btn-block text-left">Real Estate registration and
                                    transfer fees </a>
                                <a href="#"
                                    class="btn btn-primary btn-sm btn-block text-left">Setting up a business in UAE </a>
                                <a href="#"
                                    class="btn btn-primary btn-sm btn-block text-left">Tax system for properties in the
                                    UAE </a>
                                <a href="#"
                                    class="btn btn-primary btn-sm btn-block text-left">Visa Process for property
                                    owners</a>
                                <a href="#"
                                    class="btn btn-primary btn-sm btn-block text-left">Account opening process for
                                    Property Owners</a>
