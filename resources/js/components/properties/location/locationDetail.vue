                ...
                <div class="col-lg-8 col-md-9 col-sm-12">
                    ...
                    <nav aria-label="Page navigation example" v-if="cities.last_page > 1">
                        <ul class="pagination">
                            ...
                            <li class="page-item" v-for="page in Array.from({ length: cities.last_page }, (_, i) => i + 1)" :key="page" :class="{ active: page === cities.current_page }">
...
export default {
    ...
    methods: {
        async fetchCities(pageUrl = '/api/locations') {
            try {
        ...
        getPageUrl(page) {
            return `/api/locations?page=${page}`;
        },
    },
};
</script>
