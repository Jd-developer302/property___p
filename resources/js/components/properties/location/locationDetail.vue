                ...
                <div class="col-lg-8 col-md-9 col-sm-12">
                            ...
                            <div class="signle-vert-listing-item loc-list">
                                <a class="listing-item" href="#">
                                    <div class="listing-items">
                                        <div class="listing-shot-img">
                                            <img width="115" height="121" :src="frenchImage"
                                                data-echo="" class="img-responsive"
                                                alt="strLocName">
                                        </div>
                                    </div>
                                </a>
                                <div class="verticle-listing-caption">
                                    <div class="listing-shot-caption">
                                        <h4>Al Bada</h4>
                                        <p class="my-1"><small>Total Area : </small><strong>2.00 KM<sup>2</sup></strong>
                                        </p>
                                        <p class="my-1"><small>Density : </small><strong>19408 Per
                                                KM<sup>2</sup></strong></p>
                                        <p class="my-1"><small>Population : </small><strong>54338</strong></p>
                                        <a class="btn-hover default-btn mt-3" href="#">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="verticleilist listing-shot">
                            <div class="signle-vert-listing-item loc-list">
                                ...
                                <div class="verticle-listing-caption">
                                    <div class="listing-shot-caption">
                                        <h4>Al Bandar</h4>
                                        <p class="my-1"><small>Total Area : </small><strong>0.00 KM<sup>2</sup></strong>
                                        </p>
                                        <p class="my-1"><small>Density : </small><strong>0 Per KM<sup>2</sup></strong>
                                        </p>
                                        <p class="my-1"><small>Population : </small><strong>0</strong></p>
                                        <a class="btn-hover default-btn mt-3" href="#">Read More</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <nav id="ContentPlaceHolder1_PagingId" aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item">
                                <a id="ContentPlaceHolder1_rptPaging_lbPaging_1" class="page-link"
                                    href="#">2</a>
                            </li>

                            <li class="page-item">
                                <a id="ContentPlaceHolder1_rptPaging_lbPaging_2" class="page-link"
                                    href="#">3</a>
                            </li>
                            <li class="page-item">
                                <a id="ContentPlaceHolder1_lnkNext" aria-label="Next"
                                    href="#"> <span
                                        aria-hidden="true">»</span></a>
                            </li>
                            <li class="page-item HideContent">
                        ...
                        <div class="widget-boxed-body">
                            <div class="side-list">
                                <ul id="ContentPlaceHolder1_TopCommunityId" class="category-list">
                                    <li><a href="#">JVC<span style="color: #9C3133;">101
                                                <small>Projects</small></span></a></li>
                                    <li><a href="#">Business Bay<span style="color: #9C3133;">62
                                                <small>Projects</small></span></a></li>
                                    <li><a href="#">Dubailand<span style="color: #9C3133;">44
                                                <small>Projects</small></span></a></li>
                                    <li><a href="#">Downtown Dubai<span style="color: #9C3133;">43
                                                <small>Projects</small></span></a></li>
                                    <li><a href="#">Dubai Hills Estate<span style="color: #9C3133;">38
                                                <small>Projects</small></span></a></li>
                                </ul>
                            </div>
                        </div>
...
.navbar,.page-link,html,sup {
    position: relative
}

.topbar .header.light .act-buttons a.login,.topbar.fixed-header .act-buttons .login,.topbar.fixed-header .act-buttons a.login,a {
    color: #546e7a
}

.default-btn,.loader span,.send span {
    letter-spacing: 1px
}
...
.btn:focus,.btn:hover,.menuBox .content li a,.navbar-brand:focus,.navbar-brand:hover,.page-link:focus,.page-link:hover,.pagination>li>a,a,a:focus,a:hover {
...
.fixed-header .header.exchange-logo .default-logo,aside,footer,nav,section {
    display: block
}
...
.col,.col-lg-12,.col-lg-2,.col-lg-3,.col-lg-4,.col-lg-7,.col-lg-8,.col-lg-9,.col-md-12,.col-md-3,.col-md-4,.col-md-5,.col-md-8,.col-md-9,.col-sm-12,.col-sm-4,.col-sm-8 {
    position: relative;
    width: 100%;
    min-height: 1px;
    padding-right: 15px;
...
.btn-success:hover,.btn:hover,.footer-widget ul li a,footer .contact a {
    color: #fff
}
...
.booking-form .form-control,.widget-boxed .form-control,select.form-control:not([size]):not([multiple]) {
    height: 46px
}
...
.fixed-header .header.exchange-logo .sticky-logo,.header .sticky-logo {
    display: none
}
...
.act-buttons .login,.act-buttons a.login {
    cursor: pointer;
    color: #000
}
...
.signle-vert-listing-item.loc-list .listing-shot-img {
    text-align: center;
    background: #dcdcdc;
    padding: 4em
}

.signle-vert-listing-item.loc-list .listing-shot-img img {
    max-width: 100px;
    min-width: auto;
    margin: 0 auto
}
...
.side-list ul,ul.footer-bottom-social {
    margin: 0;
    padding: 0
}
...
footer .contact p i,ul.footer-bottom-social li i {
    margin-right: 5px
}
...
.verticleilist.listing-shot .verticle-listing-caption .listing-shot-caption h4{
    color: #37436c;
}
.verticleilist.listing-shot .verticle-listing-caption .listing-shot-caption small{
color: #000;
}

.verticleilist.listing-shot .verticle-listing-caption .listing-shot-caption strong{
    color: #000;
}
 .default-btn {
        display: inline-block;
